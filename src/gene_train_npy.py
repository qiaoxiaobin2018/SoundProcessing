...
#
# save_path = "F:/vox_data_mfcc_npy/train_1251"
# load_file_list = "D:\Python_projects\soundProcessing\src/test_list_iden.txt"
# save_file_list = "D:\Python_projects\SoundProcessing\src/train_for_iden.csv"
# ====================linux========================
fa_data_dir_old = "/home/longfuhui/all_data/vox1-dev-wav/wav/"

save_path = "/home/longfuhui/vox_data_fbank_npy/train_256"
load_file_list = "/home/longfuhui/shengwenshibie/SoundProcessing/src/train_list_iden.txt"
save_file_list = "/home/longfuhui/shengwenshibie/SoundProcessing/src/train_for_iden.csv"
# ============================================
save_list = []
...
def save_mfcc(mfcc,lable,id,lable_c):
    ...
    # 生成文件名
    if (lable >= 1000):
        filename = "id1" + str(lable) + "_" + str(lable_c) +"_" +str(id) + ".npy"
    elif (lable >= 100):
        filename = "id10" + str(lable) + "_" + str(lable_c) +"_" +str(id) + ".npy"
    elif (lable >= 10):
        filename = "id100" + str(lable) + "_" + str(lable_c) +"_" +str(id) + ".npy"
    else:
        filename = "id1000" + str(lable) + "_" + str(lable_c) +"_" +str(id) + ".npy"
    # 添加到新的文件列表
