...
# =================windows===========================
load_file_list = "D:\Python_projects\soundProcessing\src/train_128_mfcc_for_veri.txt" # train_128_mfcc_for_veri.txt
save_file_list = "D:\Python_projects\SoundProcessing\src/train_128_pairs_for_veri.csv"
# =================linux===========================
# load_file_list = "/home/longfuhui/shengwenshibie/SoundProcessing/src/train_128_mfcc_for_veri.txt" # train_128_mfcc_for_veri.txt
# save_file_list = "/home/longfuhui/shengwenshibie/SoundProcessing/src/train_128_pairs_for_veri.csv"
save_list = []
list_file_length_1 = 43706
...
def create_pos_pairs(first):
    ...
    write_csv(voice_list[first], voice_list[first+3], 1)
...
def create_neg_pairs(first,list):
    ...
    write_csv(voice_list[first], voice_list[list[2]],0)
